...
### Eliminá los comprobantes de prueba:
...
1.  **Contratar una suscripción de tipo "API"**
    ...
    4. Tene en cuenta que si tu plan API DEV se encuentra activo y vigente por unos dias más, la suscripción que adquieras comenzará al finalizar ésta. En ese caso, podes escribirnos a api@tusfacturas.app para que la anulemos o [bien activar manualmente la nueva suscripción](https://ayuda.tusfacturas.app/es/articles/10354324-me-quede-sin-cupo-como-activo-mi-nueva-suscripcion-a-partir-de-hoy) contratada una vez acreditado su pago desde Menú > Mi cuenta > Mis suscripciones.
