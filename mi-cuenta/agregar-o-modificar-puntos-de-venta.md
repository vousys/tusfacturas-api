...
<table><thead><tr><th width="195.7421875">Name</th><th width="131.42578125">Type</th><th width="345.05859375">Description</th></tr></thead><tbody><tr><td>operacion</td><td>string / requerido</td><td><p>Valores esperados: A o M</p><p>A = Alta de nuevo punto de venta</p><p></p><p>M = Modifica el punto de venta, correspondiente a las apikey desde las cuales estoy enviando para hacer el request.</p></td></tr><tr><td>conceptos_tipo</td><td>string / requerido</td><td><p>Debe indicar el tipo de conceptos que factura, los cuales pueden ser:</p><p>P = Productos</p><p>PS = Productos y Servicios</p><p>S = Servicios</p></td></tr><tr><td>es_predeterminado</td><td>string / requerido</td><td>Indica si el CUIT + Punto de venta es el predeterminado. Valores esperados: S o N</td></tr><tr><td>esta_activo</td><td>string / requerido</td><td>Indica si el CUIT + Punto de venta se encuentra activo y disponible para generar comprobantes. Valores esperados: S o N</td></tr><tr><td>es_agente_retencion</td><td>string / requerido</td><td>Indica si el punto de venta es agente de retención. Valores esperados: S o N.</td></tr><tr><td>factura</td><td>object / requerido</td><td>Un objeto del tipo "factura" según se detalla abajo.</td></tr><tr><td>punto_venta</td><td>number / requerido</td><td><p>El número del punto de venta a crear.</p><p>Ej: 4</p></td></tr><tr><td>factura_afip</td><td>string / requerido</td><td><p>Indica si va a querer <a href="https://www.tusfacturas.app/como-empezamos-a-hacer-facturas-electronicas.html">emitir factura electrónica AFIP</a>. En el caso que la respuesta sea "S", se enviará ademas, via email (a la casilla del administrador), el instructivo para realizar el enlace con AFIP, junto con el certificado de seguridad requerido por AFIP.</p><p></p><p>Valores esperados: S o N.</p><p></p></td></tr><tr><td>fecha_inicio</td><td>string / requerido</td><td>Fecha de inicio de actividades. Formato: dd/mm/aaaa</td></tr><tr><td>iibb</td><td>string / requerido</td><td>El nro de ingresos brutos.</td></tr><tr><td>iva_emails</td><td>string / opcional</td><td>Las direcciones de email separadas por coma donde quieren recibir mensualmente el iva compras-ventas.</td></tr><tr><td>iva_condicion</td><td>string / requerido</td><td>La condición impositiva según tabla de referencia.</td></tr><tr><td>direccion</td><td>string / requerido</td><td>El domicilio fiscal. Dirección + número</td></tr><tr><td>cuit</td><td>number / requerido</td><td>Tu CUIT. Solo números.</td></tr><tr><td>razon_social</td><td>string / requerido</td><td>La razón social</td></tr><tr><td>apitoken</td><td>string / requerido</td><td>Tus credenciales actuales de acceso.</td></tr><tr><td>apikey</td><td>string / requerido</td><td>Tus credenciales actuales de acceso.</td></tr><tr><td>usertoken</td><td>string / requerido</td><td>Tus credenciales actuales de acceso.</td></tr><tr><td>webhook</td><td>string / OPCIONAL</td><td><p>Campo alfanumérico de hasta 255 caracteres. Formato esperado: https://www.dominio.com/script-nombre. El valor que envies aca será validado y debe responder con un codigo de http = 200. Caso contratario la información de tu punto de venta no se actualizará.  </p><p><a href="../api-factura-electronica-afip-facturacion-ventas/webhooks-notificaciones.md#direccion-del-webhook">Más información</a></p></td></tr><tr><td>reg_transparencia_provincial</td><td>object / requerido </td><td>Un objeto del tipo "reg_transparencia_provincial" según se detalla abajo.</td></tr><tr><td>actividad_enviar_arca</td><td>string / OPCIONAL</td><td><p>Luego de crear o actualizar tu punto de venta recuperamos desde ARCA las actividades asociadas a tu CUIT. Indica si queres enviar de manera automatica a ARCA, en todas las ventas, la actividad que tenes predeterminada.  Éste dato hoy es opcional para el envío a ARCA. Sugerimos consultar con el estudio contable.</p><p>Valores esperados: S o N</p></td></tr><tr><td></td><td></td><td></td></tr></tbody></table>

#### Objeto "factura"

{% hint style="info" %}
Conocé más sobre [cómo configurar el estilo del PDF](https://ayuda.tusfacturas.app/es/articles/10354317-como-cambio-el-estilo-de-las-facturas-en-pdf-que-emito), [cómo configurar el tipo de envío del PDF](https://ayuda.tusfacturas.app/es/articles/12355005-como-cambiar-la-configuracion-para-enviar-facturas-como-adjuntos-pdf).&#x20;
{% endhint %}

| Campo a enviar                   | Descripcion                                                                                                                                                                                                                                                                                                                                                                                                            |
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| leyenda\_general\_predeterminada | OPCIONAL - Una leyenda predeterminada que saldrá impresa en todos los comprobantes que emitas.                                                                                                                                                                                                                                                                                                                         |
| titulo                           | REQUERIDO - El titulo que saldrá como encabezado de la factura. En gral se usa la razón social o el nombre de fantasía de la empresa. Máx de caracteres permitidos: 18                                                                                                                                                                                                                                                 |
| subtitulo                        | REQUERIDO - El subtitulo que saldrá en el encabezado de la factura, bajo el titulo principal. Máx de caracteres permitidos: 18                                                                                                                                                                                                                                                                                         |
| reply\_to\_email                 | REQUERIDO - La dirección de email para los reply-to en cada envío de comprobante.                                                                                                                                                                                                                                                                                                                                      |
| reply\_to                        | REQUERIDO - El nombre de quien envía los comprobantes.                                                                                                                                                                                                                                                                                                                                                                 |
| mensaje                          | REQUERIDO - El mensaje predeterminado que saldrá en el envío de cada comprobante.                                                                                                                                                                                                                                                                                                                                      |
| copias                           | REQUERIDO - La cantidad de copias que se generan dentro del PDF. Valores esperados: 2= para recibir original y duplicado, 3= para recibir original, duplicado y triplicado                                                                                                                                                                                                                                             |
...
| Campo a enviar | Descripcion                                                                                                                                                 |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| fecha\_inicio  | REQUERIDO - Una leyenda predeterminada que saldrá impresa en todos los comprobantes que emitas.                                                             |
| texto          | REQUERIDO - El texto que se imprimirá dentro del bloque de "Regimen de transparencia fiscal", indicando la adecuación de tu provincia. Máx: 100 caracteres. |
