...
Hay ciertos casos donde AFIP exige que en lugar de emitir una factura A,B o C, debes emitirle a tu cliente FACTURA DE CREDITO ELECTRONICA MiPyME (FCE) A, B o C. En ese caso, recibirás el campo  requiere\_fec = "SI"
