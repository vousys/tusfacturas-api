---
description: >-
  TusFacturasAPP: API para Facturas B  a clientes del exterior AFIP/ARCA.
  Confiable desde 2015. Creada por devs y respaldada por expertos impositivos.
  ¡Los desarrolladores la aman!
icon: code
---

# Factura B a cliente del exterior

### Endpoints

Factura B (  Código ARCA: 006  ) emitida en la modalidad "[Instantánea](../api-factura-electronica-afip-facturacion-ventas/api-factura-electronica-afip-facturacion-nuevo-comprobante.md)"
