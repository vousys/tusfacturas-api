...
Este método permite reenviar un comprobante a tu cliente por correo electrónico, tantas veces como sea necesario.

**Consideración importante:** La función de reenvío por email solo estará habilitada si, al momento de generar el comprobante original, se había configurado el envío por correo electrónico en el perfil del cliente.
...
#### Detalle de la estructura del Body
