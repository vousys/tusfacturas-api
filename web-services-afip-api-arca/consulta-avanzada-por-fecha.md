---
description: >-
  Servicio API de TusFacturasAPP para consultar tus ventas por fecha. Confiable
...
### JSON para consultar ventas por fecha
...
Podes enviar un request para consultar tus ventas en una determinada fecha, mediante CURL o usando tu lenguaje de programación favorito. A continuación te mostramos algunos ejemplos. Reemplaza "TUSFACTURAS\_JSON\_DATA" por el JSON especificado anteriormente.
