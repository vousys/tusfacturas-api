...
Los Recibos C de ARCA (  Código ARCA: 015  ) son comprobantes fiscales que **funcionan de manera similar a las facturas "C" tradicionales**. Se utilizan para documentar operaciones comerciales, suman en la cuenta corriente de tu cliente y tienen validez ante ARCA. No son recibos de cobro.
