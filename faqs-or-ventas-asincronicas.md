...
Debes solucionar el inconveniente y probar de enviar a re-procesar ese comprobante, usando el método de ["Reenviar a procesar, comprobante encolado con error"](web-services-afip-api-arca/reenvio-de-comprobantes-encolados-con-error.md)
